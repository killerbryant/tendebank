	...
	$(function() {
		...
		$("#checkItems").click(function(event) {
			...
			if(collapseRemoveResult) {
				...
				var ngScope =  angular.element($("#cartItemDiv")).scope();
				// 沒有商品數直接跳轉置商品頁
		...
		$("#checkFinalOrder").click(function(event) {
			...
			if(collapseRemoveResult) {
				...
				orderItemlist.find("table").css({"width":"100%"});
...
<div id="accordion-demo" class="panel-group" ng-controller="checkoutCartCtrl">
					...
					<div class="container">
						...
						<div class="col-md-6 col-xs-10 register">
							<div class="form-group">
								<label for="orderName" class="col-sm-3 control-label">訂購人名：</label>
								<div class="col-sm-9">
							...
							<div class="form-group">
								<label for="address" class="col-sm-3 control-label">常用地址：</label>
								<div class="col-sm-9">
